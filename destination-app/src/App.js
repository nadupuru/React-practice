...
import Destinationsearch from './component'
import './index.css'
...
const App = () =>{
  ...
  const filerdata=destinationsList.filter(each=>
  ...
  return(
    <div className='container'>
      <div className='div'>
        ...
        <input type='search' className='inputsearch' value={search} placeholder='seach' onChange={oninputdata}/>
      </div>
      <ul className='list'>
        {filerdata.map(each=>
